...
#define immJ() do { *imm = SEXT((BITS(i, 31, 31) << 19) | (BITS(i, 19, 12) << 11) | (BITS(i, 20, 20) << 10) | (BITS(i, 30, 21) << 0) , 20)<<1; } while(0)
#define immB() do { *imm = SEXT((BITS(i, 31, 31) << 11) | (BITS(i, 30, 25) << 4) | (BITS(i, 11, 8)) |  (BITS(i, 7, 7) << 10)  , 12) << 1;} while(0)
...
static void decode_operand(Decode *s, int *rd, word_t *src1, word_t *src2, word_t *imm, int type) {
  ...
  *rd     = BITS(i, 11, 7);
  //printf("type_i:%d U:%d S:%d R:%d J:%d B:%d N:%d",TYPE_I,TYPE_U,TYPE_S,TYPE_R,TYPE_I,TYPE_I,TYPE_I)
  switch (type) {
